...
export default {
    ...
    error_long_is_ineligible: 'Bạn hiện tại không đủ điều kiện\nthực hiện chức năng này.',
    ...
    error_transfer_input_is_too_small: `Số chip {{type}} tối thiểu\nlà {{min}} ${currencyName}.`,
    error_transfer_input_is_not_enough: `Bạn cần tối thiểu {{amount}} ${currencyName}\nđể thực hiện thao tác này.`,
