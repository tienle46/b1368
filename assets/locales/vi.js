...
export default {
    ...
    sending_login_data: 'Đang gửi thông tin đăng nhập ...',
    connecting_to_server: "Đang kết nối tới máy chủ",
    ...
    error_user_not_enough_gold_to_join_room: `Bạn cần {{minBalance}} ${currencyName} để có thể tham gia bàn chơi.Bạn có muốn Nạp ${currencyName} để tiếp tục ?`,
    error_exchange_dialog_need_to_choice_item: "Chưa chọn loại phần thưởng",
    error_exchange_dialog_not_enough_money: `Số ${currencyName} hiện tại {{ownerCoin}} ${currencyName} không đủ để đổi vật phẩm {{name}}`,
    ...
    error_need_to_pick_option_create_room_dialog: 'Chưa chọn mức cược!',
    ...
    error_transfer_input_is_invalid: `Số ${currencyName} {{type}} không hợp lệ.`,
    error_transfer_fee_type: 'Chưa chọn người chịu phí!',
    error_transfer_input_is_over_max: `Số ${currencyName} {{type}} không được vượt quá {{max}}.`,
    ...
    error_please_input_withdraw_amount: `Vui lòng nhập số ${currencyName} cần rút`,
    error_withdraw_amount_cannot_small_than: `Số ${currencyName} cần rút không được nhỏ hơn {{amount}} ${currencyName}`,
    error_withdraw_amount_must_greater_than_zero: `Số ${currencyName} cần rút phải lớn hơn 0`,
    error_withdraw_amount_unable_to_greater_than: `Số ${currencyName} cần rút không được lớn hơn {{amount}} ${currencyName}`,
    error_account_out_of_money: `Tài khoản của bạn đã hết ${currencyName}`,
    ...
    otp_message: 'Để sử dụng tính năng này, vui lòng cài ứng dụng OTP hoặc gọi hotline: {{supportHotline}} để được hỗ trợ',
    ...
    is_not_enough_money_to_bet: `Bạn không đủ ${currencyName} để thực hiện thao tác này`,
    is_waiting_card: 'Đang chờ duyệt thẻ',
    trading_is_cancelled: 'Giao dịch bị huỷ bỏ',
    trading_is_progessing: 'Giao dịch đang được xử lý',
    got_money: `Đã nhận lại ${currencyName}`,
    ...
    label_deny: 'Hủy',
    label_close: 'Đóng',
    label_withdrawal: `Rút ${currencyName}`,
    ...
    label_input_withdrawal_amount: `Nhập số ${currencyName} cần rút`,
    label_topup_money: `Nạp ${currencyName}`,
    ...
    game_table_name: 'B{{tableName}} - {{gameBet}}',
    ...
    game_bacay_ask_to_accept_cuoc_bien: `{{player}} muốn CƯỢC BIÊN với bạn {{value}} ${currencyName}`,
