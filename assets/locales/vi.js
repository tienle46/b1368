...
export default {
    ...
    error_user_not_enough_gold_to_join_room: `Bạn cần {{minBalance}} ${currencyName} để có thể tham ra bàn chơi. Bạn có muốn Nạp Tiền để tiếp tục ?`,
    error_exchange_dialog_need_to_choice_item: "Chưa chọn loại phần thưởng",
    error_exchange_dialog_not_enough_money: `Số tiền hiện tại {{ownerCoin}} ${currencyName} không đủ để đổi vật phẩm {{name}}`,
    ...
    error_transfer_input_is_not_over_allow: `Số tiền mỗi lần {{type}} không được vượt quá {{limit}} ${currencyName}.`,
    error_transfer_input_is_too_small: `Số tiền {{type}} tối thiểu là {{min}} ${currencyName}.`,
    ...
    error_withdraw_amount_cannot_small_than: `Số tiền cần rút không được nhỏ hơn {{amount}} ${currencyName}`,
    error_withdraw_amount_must_greater_than_zero: 'Số tiền cần rút phải lớn hơn 0',
    error_withdraw_amount_unable_to_greater_than: `Số tiền cần rút không được lớn hơn {{amount}} ${currencyName}`,
